...
export function generateMagicLinkEmailHTML(magicLink: string, email: string) {
  return `
    <!DOCTYPE html>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
              ...
              <tr>
                <td style="background: linear-gradient(135deg, #2563eb 0%, #4f46e5 100%); padding: 40px 20px; text-align: center;">
                  ...
                  <p style="color: #e0e7ff; margin: 10px 0 0 0; font-size: 16px;">Your CRM Access</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding: 40px 30px;">
                  <h2 style="color: #1f2937; margin: 0 0 20px 0; font-size: 24px;">Hello!</h2>
                  
                  <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                    Your CRM access is ready. Click the button below to log in:
                  </p>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" style="padding: 20px 0;">
                        <a href="${magicLink}" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #2563eb 0%, #4f46e5 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-size: 18px; font-weight: bold; box-shadow: 0 4px 6px rgba(37, 99, 235, 0.3);">
                          Log In to CRM
                        </a>
                      </td>
                    </tr>
                  ...
                  <p style="color: #9ca3af; font-size: 12px; line-height: 1.6; margin: 30px 0 0 0;">
                    This link will expire in 1 hour. If you didn't request this link, please ignore this email.
                  </p>
                </td>
              </tr>
              ...
              <tr>
                <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                  ...
                  <p style="color: #9ca3af; font-size: 12px; margin: 0;">
                    © ${new Date().getFullYear()} Pashkovsky Group. All rights reserved.
                  </p>
                </td>
              </tr>
            </table>
