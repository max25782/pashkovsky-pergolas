...
export const ORDER_STATUS_CONFIG: Record<OrderStatus, StatusConfig> = {
  pending_price: {
    ...
    labels: { ru: 'Ожидает цены', en: 'Pending Price', he: 'ממתין למחיר' },
  },
  priced: {
    color: 'bg-blue-500/20 text-blue-300 border-blue-500/50',
    labels: { ru: 'Цена установлена', en: 'Priced', he: 'מחיר הוגדר' },
  },
  confirmed: {
    color: 'bg-green-500/20 text-green-300 border-green-500/50',
    labels: { ru: 'Подтвержден', en: 'Confirmed', he: 'אושר' },
  },
  preparing: {
    color: 'bg-purple-500/20 text-purple-300 border-purple-500/50',
    labels: { ru: 'Готовится', en: 'Preparing', he: 'בהכנה' },
  },
  ready: {
    color: 'bg-cyan-500/20 text-cyan-300 border-cyan-500/50',
    labels: { ru: 'Готов', en: 'Ready', he: 'מוכן' },
  },
  delivered: {
    color: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/50',
    labels: { ru: 'Доставлен', en: 'Delivered', he: 'נמסר' },
  },
  cancelled: {
    color: 'bg-red-500/20 text-red-300 border-red-500/50',
    labels: { ru: 'Отменен', en: 'Cancelled', he: 'בוטל' },
  },
}
