...
-- Create new offers table with updated structure
CREATE TABLE public.offers (
  ...
  -- Pricing (NEW FORMULA: discount applied AFTER VAT)
  total_before_vat NUMERIC(10, 2) NOT NULL,
  vat_percent NUMERIC(5, 2) NOT NULL DEFAULT 18, -- Changed to 18%
  vat_amount NUMERIC(10, 2) NOT NULL,
  price_with_vat NUMERIC(10, 2) NOT NULL,
  
  discount_percent NUMERIC(5, 2) NOT NULL DEFAULT 0,
  discount_amount NUMERIC(10, 2) NOT NULL DEFAULT 0, -- Applied after VAT
  
  final_price NUMERIC(10, 2) NOT NULL, -- price_with_vat - discount_amount
